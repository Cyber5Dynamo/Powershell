...
$PrivateKeyLocation = "C:\Users\$env:username\.ssh\id_ed25519"
...
# (Admin terminal)
Set-ExecutionPolicy Bypass -Scope Process
Invoke-Command -VMName "Firewall" -FilePath C:\Users\do5dt\Documents\VisualStudioDateien\Powershell\Modul1_Übung\Common_Setup.ps1 -ArgumentList "GW01"
Invoke-Command -VMName "Domain Controller" -FilePath C:\Users\do5dt\Documents\VisualStudioDateien\Powershell\Modul1_Übung\Common_Setup.ps1 -ArgumentList "DC01"
Invoke-Command -VMName "DHCP Server" -FilePath C:\Users\do5dt\Documents\VisualStudioDateien\Powershell\Modul1_Übung\Common_Setup.ps1 -ArgumentList "DHCP01"
Invoke-Command -VMName "DHCP Relay" -FilePath C:\Users\do5dt\Documents\VisualStudioDateien\Powershell\Modul1_Übung\Common_Setup.ps1 -ArgumentList "RELAY01"

# Ready to connect!
# Ab hier für alle KOmmandos PowerShell 7 benutzen
Enter-PSSession -HostName "dc01" -UserName "Administrator" -KeyFilePath C:\Users\do5dt\.ssh\id_ed25519
